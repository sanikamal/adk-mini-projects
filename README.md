# Google ADK Showcase Projects

This repository is a collection of multiple Google Agent Development Kit (ADK) projects designed for showcase and reference. It serves as a central place to explore various agentic applications and capabilities built using the Google ADK.
